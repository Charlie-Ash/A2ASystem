...
class RAGTool():
    ...
    def run(self, tool_args):
        ...
        if not query:
            return {"output": "RAG tool error: no query was provided.", "relay_verbatim": False}
        ...
        relevant_info_list = user_query(self.index, query)
        context_block = "\n\n".join(
        ...
        try:
            ...
            return {"output": f"RAG tool error: generation failed ({e})", "relay_verbatim": False}
        ...
        return {"output": answer, "relay_verbatim": True}
